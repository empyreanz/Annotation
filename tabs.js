/*
 * This file is based on Super Simple Highlighter.
 * 
...
var _tabs = {
    ...
    executeScripts: function (tabId, injectDetailsArray, finalCallback) {
        ...
        function createCallback(tabId, injectDetails, innerCallback) {
            return function () {
                chrome.tabs.executeScript(null, injectDetails, innerCallback);
            };
        }
    ...
    executeAllScripts: function (tabId, allFrames, callback) {
        ...
        [
            "tool/jquery-2.1.3.min.js",
            "tool/jquery.stylesheet.min.js",
            // "js/storage.js",
            // "js/string_utils.js",
            // "js/stylesheet.js",
            "backend/xpath.js",
            "backend/highlighter.js",
            "backend/content_script.js"
    ...
    sendMessage: function (tabId, message, responseCallback) {
        "use strict";
        chrome.extension.getBackgroundPage().console.log('sendMessage')
        chrome.tabs.sendMessage(tabId, message, function (response) {
            ...
            if (response === undefined) {
                chrome.extension.getBackgroundPage().console.log("sendMessage() response undefined. Executing scripts, then retrying...");
    ...
    sendCreateHighlightMessage: function (tabId,
                                          ...
                                          responseCallback) {
        console.log('sendCreateHighlightMessage');
        "use strict";
    ...
    sendGetSelectionRangeMessage: function (tabId, responseCallback) {
        "use strict";
        console.log('sendSelectHighlightTextMessage');
        chrome.extension.getBackgroundPage().console.log('sendSelectHighlightTextMessage');
        _tabs.sendMessage(tabId, {
